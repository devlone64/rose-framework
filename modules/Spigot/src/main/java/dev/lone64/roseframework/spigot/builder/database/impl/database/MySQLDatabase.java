...
public class MySQLDatabase implements SQLDatabase {
    ...
    public MySQLDatabase(JavaPlugin plugin, String hostname, String port, String name, String username, String password) {
        this.connection = new MySQLConnection(plugin, hostname, port, name, username, password);
    }
